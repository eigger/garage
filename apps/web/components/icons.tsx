// 이모지 대신 쓰는 선(stroke) 스타일 아이콘 모음. 전부 currentColor를 써서
// 부모 요소의 color를 그대로 물려받는다 — 별도 색상 prop 없이 배치한 자리의 텍스트
// 색과 항상 맞는다.
...
// 지남(꽉 찬 삼각형)과 임박(테두리만) 두 상태를 채움 여부로 구분한다 — 아이콘 모양은
// 같게 유지하면서 강도 차이만 다르게.
export function AlertIcon({ size = 16, filled = false }: IconProps & { filled?: boolean }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill={filled ? "currentColor" : "none"} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <line x1="12" y1="9" x2="12" y2="13" stroke={filled ? "#fff" : "currentColor"} />
      <line x1="12" y1="17" x2="12.01" y2="17" stroke={filled ? "#fff" : "currentColor"} />
    </svg>
  );
}
...
export function LeafIcon({ size = 12 }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function BarChartIcon({ size = 12 }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function RouteIcon({ size = 12 }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function PlugIcon({ size = 20 }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M7 6v4" />
      <path d="M11 6v4" />
      <path d="M7 10H3a1 1 0 0 0-1 1v2a5 5 0 0 0 10 0v-2a1 1 0 0 0-1-1h-4z" />
      <path d="M14.5 15.5 17 18" />
      <path d="M17 18l3.5 3.5" />
    </svg>
  );
}
...
export function MoreDotsIcon({ size = 20 }: IconProps) {
  return (
