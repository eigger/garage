...
차량별 허브입니다. 최근 주유 비용을 포함한 요약 카드, 월간 비용 차트와 **개요 / 정비 스케줄 / 내역** 탭이 제공됩니다. 톱니바퀴 아이콘에서 차량 설정과 OBD/GPS를 열 수 있습니다. 기존의 상단 헤더 바가 하단 네비게이션 구조로 단일화되었으며, 관리 기능은 하단 네비게이션의 **더보기** 시트 안에 깔끔하게 모여 있습니다.
...
주행·주유·정비 이력을 한곳에서 모아 봅니다. 만탱크 주유 사이의 연비(`km/L`, `L/100km`)와 주행 리포트가 자동으로 계산됩니다.
