...
로그인 후 홈 화면입니다. **차량 관리**, **사용자 관리**, **정비 마스터 프리셋 관리**, **API 연동 관리**로 이동합니다. 등록된 차량마다 주행거리, 최근 주행, 최근 주유 비용, 지남/임박 알림 건수가 표시됩니다.

<img src="https://raw.githubusercontent.com/eigger/garage/master/docs/screenshots/ko/01-dashboard.png" alt="대시보드" width="960" />

### 2. 차량 개요

차량별 허브입니다. 요약 카드·월간 비용과 **개요 / 빠른 입력 / 정비 스케줄 / 내역** 탭이 있습니다. 톱니바퀴 아이콘에서 차량 설정과 OBD/GPS를 엽니다.

<img src="https://raw.githubusercontent.com/eigger/garage/master/docs/screenshots/ko/02-vehicle.png" alt="차량 개요" width="960" />

### 3. 빠른 입력

차량 페이지에서 주유·정비를 바로 기록합니다. 주유 탭은 주유소, 단가, 리터, 금액 단축 버튼, 영수증 첨부를 지원합니다. **정비** 탭에서는 스케줄 항목과 연결된 정비 기록을 남깁니다.
...
주행·주유·정비 이력을 한곳에서 봅니다. 만탱크 주유 사이 연비(`km/L`, `L/100km`)도 계산됩니다.

<img src="https://raw.githubusercontent.com/eigger/garage/master/docs/screenshots/ko/05-history.png" alt="내역" width="960" />

### 6. API 연동 관리

오피넷, 카카오맵, 네이버 지도, T맵 키를 관리하는 관리자 화면입니다. 저장 즉시 적용되며(재시작 불필요), 백업 파일에는 포함되지 않습니다.
...
해당 연료 타입 정비 프리셋과 행정·법정 스케줄(검사, 보험, 세금 등)이 자동으로 복사됩니다. 기본값은 **정비 마스터 프리셋 관리**에서 수정합니다.
